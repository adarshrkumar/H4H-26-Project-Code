/**
 * Compose page — converted from src/pages/index.astro.
 * Server Component: static HTML shell rendered on the server.
 * IndexScriptRunner (client component) attaches all interactivity after hydration.
 */
...
const sections = [
    {
        id: 'intro',  icon: '🎬', name: 'Intro',
        question: "Let's build your story. What should your Intro feel like?",
        placeholder: 'Add your own details for the intro…',
    },
    {
        id: 'verse1', icon: '📖', name: 'Verse 1',
        question: 'What should your first Verse feel like?',
        placeholder: 'Describe your first verse further…',
    },
    {
        id: 'chorus', icon: '🎆', name: 'Chorus',
        question: "What should your Chorus — the big moment — feel like?",
        placeholder: 'Describe the chorus further…',
    },
    {
        id: 'verse2', icon: '📗', name: 'Verse 2',
        question: 'How does your second Verse evolve the story?',
        placeholder: 'Describe your second verse further…',
    },
    {
        id: 'bridge', icon: '🌉', name: 'Bridge',
        question: 'What unexpected shift should your Bridge bring?',
        placeholder: 'Describe the bridge further…',
    },
    {
        id: 'outro',  icon: '🌅', name: 'Outro',
        question: 'How should your story end? What should the Outro feel like?',
        placeholder: 'Describe the outro further…',
    },
];
...
export default function ComposePage() {
    return (
        <>
            <div className="compose-page" enable-xr={"true" as unknown as boolean}>
                ...
                <section className="step-card" id="step-mood">
                    ...
                    <div className="mood-grid" id="mood-grid">
                        {moods.map(m => (
                            <button
                                key={m.value}
                                className="mood-btn"
                                enable-xr={"true" as unknown as boolean}
                                data-mood={m.value}
                                data-color={m.color}
                                data-pulse={m.pulse}
                                type="button"
                    ...
                    {/* Song identity — shared across all sections */}
                    <div className="song-identity">
                        ...
                        <input
                            type="text"
                            id="song-concept"
                            className="song-identity__input"
                        ...
                        {sections.map(s => (
                            <div key={s.id} className="section-block" data-section={s.id} id={`block-${s.id}`}>
                                ...
                                <div className="section-block__body">
                                    ...
                                    <div className="lyrics-field">
                                        <div className="lyrics-field__head">
                                            ...
                                            <button
                                                ...
                                                data-section={s.id}
                                                id={`lyrics-suggest-${s.id}`}
                                                type="button"
                                            >↺ New suggestion</button>
                                        </div>
                                        <textarea
                                            className="lyrics-field__textarea"
                                            id={`lyrics-${s.id}`}
                                            rows={4}
                                    ...
                                    <textarea
                                        className="section-block__textarea"
                                        id={`text-${s.id}`}
                                        rows={2}
